...
param_list:
  - id: scrnaseq_for_ist/2022Andrews_human_liver_sc
...
tw launch https://github.com/openproblems-bio/task_ist_preprocessing.git \
  --revision build/main \
  --pull-latest \
  --main-script target/nextflow/datasets/workflows/process_andrews_human_liver_sc/main.nf \
  --workspace 53907369739130 \
  --params-file /tmp/params.yaml \
  --config common/nextflow_helpers/labels_tw.config \
  --labels datasets,andrews_human_liver_sc

#aws s3 sync \
#  s3://openproblems-data/resources/datasets/scrnaseq_for_ist/2022Andrews_human_liver_sc \
#  resources/datasets/scrnaseq_for_ist/2022Andrews_human_liver_sc
