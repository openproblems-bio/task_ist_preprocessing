...
meta = [
      ...
      "arguments" : [
        {
          ...
          "description" : "This dataset contains images, points with cell ids, and an anndata table with processed counts and cell type annotations.\n",
          "info" : {
            "format" : {
          ...
          "example" : [
            "resources_test/task_ist_preprocessing/mouse_brain_combined/spatial_processed_complete.zarr"
          ],
          "must_exist" : true,
          "create_parent" : true,
          "required" : true,
  ...
  "resources" : [
    ...
    {
      "type" : "file",
      "path" : "/src/metrics/quality/quality_metrics.py"
    }
  ],
  "test_resources" : [
    {
  ...
  "info" : {
    "metrics" : [
      {
        "name" : "proportion_of_assigned_reads",
        "label" : "Proportion of Assigned Reads",
        "summary" : "The proportion of assigned reads.",
        "description" : "The proportion of assigned reads.\n",
        "references" : {
      ...
      {
        "name" : "proportion_of_annotated_cells",
        "label" : "Proportion of Annotated Cells",
        "summary" : "The proportion of cells that are annotated with cell types.",
        "description" : "The proportion of cells that are annotated with cell types.\n",
        "references" : {
          "doi" : "10.1101/2023.02.13.528102"
        },
        "min" : 0,
    ...
    "type_info" : {
      ...
      "description" : "This metric evaluates the quality of the iST preprocessing without using a reference.\n"
    }
  },
  "status" : "enabled",
  "scope" : {
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/metrics/quality/config.vsh.yaml",
    "runner" : "nextflow",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/metrics/quality",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
