...
meta = [
  ...
  "info" : {
    ...
    "type" : "metric",
    "subtype" : "similarity metric",
    "type_info" : {
      "label" : "Metric",
      "summary" : "A metric for evaluating iST preprocessing methods",
      "description" : "This metric evaluates the quality of the iST preprocessing based on similarity to the scRNAseq reference.\n"
    }
  },
  "status" : "enabled",
  "repositories" : [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/metrics/similarity/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker|native",
    "output" : "target/nextflow/metrics/similarity_metrics",
    "viash_version" : "0.9.0",
    "git_commit" : "d83360528b82828f7a881816d57f0fb034daa40f",
...
par = {
  ...
  'input_qc_col': $( if [ ! -z ${VIASH_PAR_INPUT_QC_COL+x} ]; then echo "r'${VIASH_PAR_INPUT_QC_COL//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/metrics/similarity_metrics",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
