// normalise_by_volume build_main
// 
...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/normalisation_methods/normalise_by_volume/config.vsh.yaml",
    "runner" : "nextflow",
...
par = {
  ...
  'input_volume': $( if [ ! -z ${VIASH_PAR_INPUT_VOLUME+x} ]; then echo "r'${VIASH_PAR_INPUT_VOLUME//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/normalisation_methods/normalise_by_volume",
    "tag" : "build_main"
  },
  "tag" : "$id"
}'''),
