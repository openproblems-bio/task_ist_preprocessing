...
meta = [
  ...
  "label" : "No Correction",
  "summary" : "Dummy method that does not correct the expression of genes",
  "description" : "Dummy method that does not correct the expression of genes.",
  "test_resources" : [
    {
      "type" : "file",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/methods_expression_correction/no_correction/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker|native",
    "output" : "target/nextflow/methods_expression_correction/no_correction",
    "viash_version" : "0.9.4",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/methods_expression_correction/no_correction",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
