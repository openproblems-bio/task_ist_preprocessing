...
meta = [
      ...
      "arguments" : [
        {
          ...
          "description" : "This file contains the normalized counts of the spatial transcriptomics data and cell type annotations.\n",
          "info" : {
            "format" : {
              "type" : "h5ad",
              "layers" : [
  ...
  "description" : "Corrects the expression of genes based on the resolVI method, a part of scvi-tools.",
  "test_resources" : [
    {
      "type" : "file",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/methods_expression_correction/resolvi_correction/config.vsh.yaml",
    "runner" : "nextflow",
...
par = {
  'input_spatial_with_cell_types': $( if [ ! -z ${VIASH_PAR_INPUT_SPATIAL_WITH_CELL_TYPES+x} ]; then echo "r'${VIASH_PAR_INPUT_SPATIAL_WITH_CELL_TYPES//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  ...
  'downsample_counts': $( if [ ! -z ${VIASH_PAR_DOWNSAMPLE_COUNTS+x} ]; then echo "r'${VIASH_PAR_DOWNSAMPLE_COUNTS//\\'/\\'\\"\\'\\"r\\'}'.lower() == 'true'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/methods_expression_correction/resolvi_correction",
    "tag" : "build_main"
  },
  "label" : [
    "hightime",
