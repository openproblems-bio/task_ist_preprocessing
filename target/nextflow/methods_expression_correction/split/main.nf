...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/methods_expression_correction/split/config.vsh.yaml",
    "runner" : "nextflow",
...
par <- list(
  "input_spatial_with_cell_types" = $( if [ ! -z ${VIASH_PAR_INPUT_SPATIAL_WITH_CELL_TYPES+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_INPUT_SPATIAL_WITH_CELL_TYPES" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
  ...
  "keep_all_cells" = $( if [ ! -z ${VIASH_PAR_KEEP_ALL_CELLS+x} ]; then echo -n "as.logical(toupper('"; echo -n "$VIASH_PAR_KEEP_ALL_CELLS" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'))"; else echo NULL; fi )
)
meta <- list(
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/methods_expression_correction/split",
    "tag" : "build_main"
  },
  "label" : [
    "hightime",
