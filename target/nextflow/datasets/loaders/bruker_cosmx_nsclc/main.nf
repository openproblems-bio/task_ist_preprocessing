...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/datasets/loaders/bruker_cosmx_nsclc/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker|native",
    "output" : "target/nextflow/datasets/loaders/bruker_cosmx_nsclc",
    "viash_version" : "0.9.7",
...
par = {
  'input_raw': $( if [ ! -z ${VIASH_PAR_INPUT_RAW+x} ]; then echo "r'${VIASH_PAR_INPUT_RAW//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'input_morphology': $( if [ ! -z ${VIASH_PAR_INPUT_MORPHOLOGY+x} ]; then echo "r'${VIASH_PAR_INPUT_MORPHOLOGY//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/datasets/loaders/bruker_cosmx_nsclc",
    "tag" : "build_main"
  },
  "label" : [
    "highmem",
