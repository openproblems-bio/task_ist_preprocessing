...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/datasets/loaders/vizgen_merscope/config.vsh.yaml",
    "runner" : "nextflow",
...
par = {
  'gcloud_bucket': $( if [ ! -z ${VIASH_PAR_GCLOUD_BUCKET+x} ]; then echo "r'${VIASH_PAR_GCLOUD_BUCKET//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'dataset_bucket_name': $( if [ ! -z ${VIASH_PAR_DATASET_BUCKET_NAME+x} ]; then echo "r'${VIASH_PAR_DATASET_BUCKET_NAME//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/datasets/loaders/vizgen_merscope",
    "tag" : "build_main"
  },
  "label" : [
    "highmem",
