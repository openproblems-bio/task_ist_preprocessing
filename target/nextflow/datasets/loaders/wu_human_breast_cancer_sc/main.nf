// wu_human_breast_cancer_sc build_main
// 
...
meta = [
  ...
  "name" : "wu_human_breast_cancer_sc",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/datasets/loaders/wu_human_breast_cancer_sc/config.vsh.yaml",
    "runner" : "nextflow",
...
par = {
  'cancer_subtypes': $( if [ ! -z ${VIASH_PAR_CANCER_SUBTYPES+x} ]; then echo "r'${VIASH_PAR_CANCER_SUBTYPES//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/datasets/loaders/wu_human_breast_cancer_sc",
    "tag" : "build_main"
  },
  "label" : [
    "veryhighmem",
