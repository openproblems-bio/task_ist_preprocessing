...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/datasets/loaders/tenx_xenium/config.vsh.yaml",
    "runner" : "nextflow",
...
par = {
  ...
  'replicate_id': $( if [ ! -z ${VIASH_PAR_REPLICATE_ID+x} ]; then echo "r'${VIASH_PAR_REPLICATE_ID//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/datasets/loaders/tenx_xenium",
    "tag" : "build_main"
  },
  "label" : [
    "highmem",
