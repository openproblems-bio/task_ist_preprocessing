// lee_human_colon_cancer_sc build_main
// 
...
meta = [
  ...
  "name" : "lee_human_colon_cancer_sc",
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "default" : [
            "This dataset contains scRNA-seq data from human colon cancer cells."
          ],
          "required" : false,
          "direction" : "input",
          "multiple" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/datasets/loaders/lee_human_colon_cancer_sc/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker|native",
    "output" : "target/nextflow/datasets/loaders/lee_human_colon_cancer_sc",
    "viash_version" : "0.9.4",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/datasets/loaders/lee_human_colon_cancer_sc",
    "tag" : "build_main"
  },
  "label" : [
    "midmem",
