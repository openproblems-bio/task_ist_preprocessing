...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/datasets/loaders/bruker_cosmx/config.vsh.yaml",
    "runner" : "nextflow",
...
par = {
  ...
  'input_flat_files': $( if [ ! -z ${VIASH_PAR_INPUT_FLAT_FILES+x} ]; then echo "r'${VIASH_PAR_INPUT_FLAT_FILES//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/datasets/loaders/bruker_cosmx",
    "tag" : "build_main"
  },
  "label" : [
    "highmem",
