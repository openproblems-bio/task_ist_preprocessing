// lu_human_liver_cancer_sc build_main
// 
...
meta = [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "default" : [
            "This dataset contains scRNA-seq data from human liver cancer cells."
          ],
          "required" : false,
          "direction" : "input",
          "multiple" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/datasets/loaders/lu_human_liver_cancer_sc/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker|native",
    "output" : "target/nextflow/datasets/loaders/lu_human_liver_cancer_sc",
    "viash_version" : "0.9.4",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/datasets/loaders/lu_human_liver_cancer_sc",
    "tag" : "build_main"
  },
  "label" : [
    "midmem",
