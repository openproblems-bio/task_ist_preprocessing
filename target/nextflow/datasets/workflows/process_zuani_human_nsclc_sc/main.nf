// process_zuani_human_nsclc_sc build_main
// 
...
meta = [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "default" : [
            "Single cell RNA sequencing atlas of non-small cell lung cancer (NSCLC)"
          ],
          "required" : true,
          "direction" : "input",
          "multiple" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/datasets/workflows/process_zuani_human_nsclc_sc/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { zuani_human_nsclc_sc } from "${meta.resources_dir}/../../../../nextflow/datasets/loaders/zuani_human_nsclc_sc/main.nf"
