...
meta = [
  ...
  "dependencies" : [
    {
      "name" : "datasets/loaders/tenx_atera",
      "repository" : {
        "type" : "local"
      }
    },
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/datasets/workflows/process_tenx_atera/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "target/nextflow/datasets/workflows/process_tenx_atera",
    "viash_version" : "0.9.7",
...
include { tenx_atera } from "${meta.resources_dir}/../../../../nextflow/datasets/loaders/tenx_atera/main.nf"
