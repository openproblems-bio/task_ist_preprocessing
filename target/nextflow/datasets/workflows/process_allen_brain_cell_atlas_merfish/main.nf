// process_allen_brain_cell_atlas_merfish build_main
// 
...
meta = [
  ...
  "name" : "process_allen_brain_cell_atlas_merfish",
  ...
  "argument_groups" : [
    ...
    {
      "name" : "Crop region",
      "description" : "If provided, the dataset will be cropped to the specified pixel coordinates.",
      "arguments" : [
        {
          "type" : "integer",
  ...
  "dependencies" : [
    {
      "name" : "datasets/loaders/allen_brain_cell_atlas_merfish",
      "repository" : {
        "type" : "local"
      }
    },
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/datasets/workflows/process_allen_brain_cell_atlas_merfish/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "target/nextflow/datasets/workflows/process_allen_brain_cell_atlas_merfish",
    "viash_version" : "0.9.7",
...
include { allen_brain_cell_atlas_merfish } from "${meta.resources_dir}/../../../../nextflow/datasets/loaders/allen_brain_cell_atlas_merfish/main.nf"
...
workflow run_wf {
  ...
  output_ch = input_ch
    ...
    | allen_brain_cell_atlas_merfish.run(
      fromState: [
        "mouse",
        "experiment_id",
        "abca_version",
