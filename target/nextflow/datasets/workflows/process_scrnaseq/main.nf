...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/datasets/workflows/process_scrnaseq/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
