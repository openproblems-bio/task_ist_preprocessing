// process_andrews_human_liver_sc build_main
// 
...
meta = [
  ...
  "name" : "process_andrews_human_liver_sc",
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "default" : [
            "This dataset contains scRNA-seq data from human liver cells."
          ],
          "required" : false,
          "direction" : "input",
          "multiple" : false,
        ...
        },
        {
          ...
          "default" : [
            "This dataset contains scRNA-seq data from human liver cells. The data has been published in Andrews et al. 2022, and reanalyzed in Andrews et al. 2024 (data accessed via the 2024 cell x gene release)."
          ],
          "required" : false,
          "direction" : "input",
          "multiple" : false,
  ...
  "dependencies" : [
    {
      "name" : "datasets/loaders/andrews_human_liver_sc",
      "repository" : {
        "type" : "local"
      }
    },
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/datasets/workflows/process_andrews_human_liver_sc/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { andrews_human_liver_sc } from "${meta.resources_dir}/../../../../nextflow/datasets/loaders/andrews_human_liver_sc/main.nf"
