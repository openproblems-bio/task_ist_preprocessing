// process_travaglini_human_lung_sc build_main
// 
...
meta = [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "default" : [
            "This dataset contains scRNA-seq data from human lung cells."
          ],
          "required" : false,
          "direction" : "input",
          "multiple" : false,
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/datasets/workflows/travaglini_human_lung_sc/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
    "output" : "target/nextflow/datasets/workflows/process_travaglini_human_lung_sc",
    "viash_version" : "0.9.4",
...
include { travaglini_human_lung_sc } from "${meta.resources_dir}/../../../../nextflow/datasets/loaders/travaglini_human_lung_sc/main.nf"
