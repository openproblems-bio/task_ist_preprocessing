...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/datasets/processors/crop_region/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'min_x': $( if [ ! -z ${VIASH_PAR_MIN_X+x} ]; then echo "int(r'${VIASH_PAR_MIN_X//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'max_x': $( if [ ! -z ${VIASH_PAR_MAX_X+x} ]; then echo "int(r'${VIASH_PAR_MAX_X//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'min_y': $( if [ ! -z ${VIASH_PAR_MIN_Y+x} ]; then echo "int(r'${VIASH_PAR_MIN_Y//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'max_y': $( if [ ! -z ${VIASH_PAR_MAX_Y+x} ]; then echo "int(r'${VIASH_PAR_MAX_Y//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/datasets/processors/crop_region",
    "tag" : "build_main"
  },
  "tag" : "$id"
}'''),
