...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/datasets/processors/subsample/config.vsh.yaml",
    "runner" : "nextflow",
...
# Guard on input_mod2 (not output_mod2): adata_output_mod2 only exists for multimodal
# input, but the Nextflow runner auto-populates the optional output_mod2 path.
if par["input_mod2"] is not None:
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/datasets/processors/subsample",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
