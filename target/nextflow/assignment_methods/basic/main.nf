...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/assignment_methods/basic/config.vsh.yaml",
    "runner" : "nextflow",
...
par = {
  ...
  'segmentation_input': $( if [ ! -z ${VIASH_PAR_SEGMENTATION_INPUT+x} ]; then echo "r'${VIASH_PAR_SEGMENTATION_INPUT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/assignment_methods/basic",
    "tag" : "build_main"
  },
  "tag" : "$id"
}'''),
