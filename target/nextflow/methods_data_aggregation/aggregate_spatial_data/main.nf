// aggregate_spatial_data build_main
// 
...
meta = [
  ...
  "description" : "This component aggregates different files of the raw and processed spatial data to one zarr file.\n",
  "test_resources" : [
    {
      "type" : "file",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/methods_data_aggregation/aggregate_spatial_data/config.vsh.yaml",
    "runner" : "nextflow",
...
par = {
  'input_raw_sp': $( if [ ! -z ${VIASH_PAR_INPUT_RAW_SP+x} ]; then echo "r'${VIASH_PAR_INPUT_RAW_SP//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  ...
  'input_spatial_corrected_counts': $( if [ ! -z ${VIASH_PAR_INPUT_SPATIAL_CORRECTED_COUNTS+x} ]; then echo "r'${VIASH_PAR_INPUT_SPATIAL_CORRECTED_COUNTS//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/methods_data_aggregation/aggregate_spatial_data",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
