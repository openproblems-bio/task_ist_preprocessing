...
meta = [
  ...
  "build_info" : {
    ...
    "output" : "target/nextflow/metrics_similarity/similarity_metrics",
    "viash_version" : "0.9.0",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/metrics_similarity/similarity_metrics",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
