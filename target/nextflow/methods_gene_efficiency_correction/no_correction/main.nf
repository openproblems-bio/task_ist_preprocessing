...
meta = [
  ...
  "description" : "Dummy method that does not apply gene efficiency correction; passes the (expression-)corrected input through unchanged.",
  "test_resources" : [
    {
      "type" : "file",
  ...
  "info" : {
    ...
    "type_info" : {
      ...
      "description" : "A gene efficiency correction method corrects for per-gene detection efficiency in the (expression-)corrected spatial counts. It runs as a separate stage after expression correction, consuming and producing the corrected-counts format."
    }
  },
  "status" : "enabled",
  "scope" : {
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/methods_gene_efficiency_correction/no_correction/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker|native",
    "output" : "target/nextflow/methods_gene_efficiency_correction/no_correction",
    "viash_version" : "0.9.7",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/methods_gene_efficiency_correction/no_correction",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
