// permute_celltype_annotations build_main
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "file",
          "name" : "--output",
          "label" : "Spatial Corrected",
          "summary" : "Corrected spatial data counts with cell type annotations",
          "description" : "This file contains the corrected counts of the spatial transcriptomics data and cell type annotations.\n",
          "info" : {
            "format" : {
              "type" : "h5ad",
              "layers" : [
        ...
        },
        {
          ...
          "name" : "--output_qc_col",
          "label" : "QC Columns",
          "summary" : "QC columns for spatial data",
          "description" : "This file contains the QC-filter column for spatial data.\n",
          "info" : {
            "format" : {
              "type" : "h5ad",
              "obs" : [
                {
                  "type" : "string",
                  "name" : "passed_QC",
                  "description" : "Whether the cell passed the quality control",
                  "required" : true
                }
              ]
            }
  ...
  "info" : {
    ...
    "type_info" : {
      ...
      "description" : "A control method for the imaging-based spatial transcriptomics preprocessing task.\n"
    }
  },
  "status" : "enabled",
  "scope" : {
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/control_methods/permute_celltype_annotations/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'output_transcript_assignments': $( if [ ! -z ${VIASH_PAR_OUTPUT_TRANSCRIPT_ASSIGNMENTS+x} ]; then echo "r'${VIASH_PAR_OUTPUT_TRANSCRIPT_ASSIGNMENTS//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output_qc_col': $( if [ ! -z ${VIASH_PAR_OUTPUT_QC_COL+x} ]; then echo "r'${VIASH_PAR_OUTPUT_QC_COL//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/control_methods/permute_celltype_annotations",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
