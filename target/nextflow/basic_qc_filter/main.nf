...
par = {
  ...
  'min_cell_percentage': $( if [ ! -z ${VIASH_PAR_MIN_CELL_PERCENTAGE+x} ]; then echo "float(r'${VIASH_PAR_MIN_CELL_PERCENTAGE//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi )
}
meta = {
