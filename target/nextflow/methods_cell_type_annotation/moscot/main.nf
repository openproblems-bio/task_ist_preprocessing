...
meta = [
  ...
  "engines" : [
    {
      "type" : "docker",
      "id" : "docker",
      "image" : "openproblems/base_pytorch_nvidia:1.1.0",
      "namespace_separator" : "/",
      "setup" : [
        {
          "type" : "python",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/methods_cell_type_annotation/moscot/config.vsh.yaml",
    "runner" : "nextflow",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/methods_cell_type_annotation/moscot",
    "tag" : "build_main"
  },
  "label" : [
    "hightime",
