...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/methods_cell_type_annotation/singler/config.vsh.yaml",
    "runner" : "nextflow",
...
par = {
  'input_spatial_normalized_counts': $( if [ ! -z ${VIASH_PAR_INPUT_SPATIAL_NORMALIZED_COUNTS+x} ]; then echo "r'${VIASH_PAR_INPUT_SPATIAL_NORMALIZED_COUNTS//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  ...
  'labels_key': $( if [ ! -z ${VIASH_PAR_LABELS_KEY+x} ]; then echo "r'${VIASH_PAR_LABELS_KEY//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/methods_cell_type_annotation/singler",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
