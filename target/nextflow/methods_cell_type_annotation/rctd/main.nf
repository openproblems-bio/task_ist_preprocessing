...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/methods_cell_type_annotation/rctd/config.vsh.yaml",
    "runner" : "nextflow",
...
par <- list(
  "input_spatial_normalized_counts" = $( if [ ! -z ${VIASH_PAR_INPUT_SPATIAL_NORMALIZED_COUNTS+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_INPUT_SPATIAL_NORMALIZED_COUNTS" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/methods_cell_type_annotation/rctd",
    "tag" : "build_main"
  },
  "label" : [
    "hightime",
