...
meta = [
    ...
    },
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "default" : [
            "ssam:tacco:moscot:mapmycells:tangram:singler:rctd"
          ],
          "required" : false,
          "direction" : "input",
          "multiple" : true,
  ...
  "dependencies" : [
    ...
    {
      "name" : "methods_transcript_assignment/segger",
      "repository" : {
        "type" : "local"
      }
    },
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/workflows/run_benchmark/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
