...
meta = [
  ...
  "info" : {
    ...
    "type_info" : {
      ...
      "description" : "This component processes a common single-cell and a common spatial transcriptomics\ndataset for the benchmark.\n"
    }
  },
  "status" : "enabled",
  "scope" : {
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/workflows/process_datasets/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "native",
...
include { process_dataset as process_dataset_comp_viashalias } from "${meta.resources_dir}/../../../nextflow/data_processors/process_dataset/main.nf"
process_dataset_comp = process_dataset_comp_viashalias.run(key: "process_dataset_comp")
