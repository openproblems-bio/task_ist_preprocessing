// normalize_by_counts build_main
// 
...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          ...
          "description" : "An obs column of cell volumes calculated from spatial transcriptomics data.\n",
          "info" : {
            "format" : {
              "type" : "h5ad",
              "obs" : [
        ...
        },
        {
          "type" : "file",
          "name" : "--output",
          "label" : "Spatial Normalized",
          "summary" : "Normalized counts",
          "description" : "This file contains the normalized counts of the spatial transcriptomics data.\n",
          "info" : {
            "format" : {
              "type" : "h5ad",
              "layers" : [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/methods_normalization/normalize_by_counts/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker|native",
    "output" : "target/nextflow/methods_normalization/normalize_by_counts",
    "viash_version" : "0.9.4",
...
par = {
  'input_spatial_aggregated_counts': $( if [ ! -z ${VIASH_PAR_INPUT_SPATIAL_AGGREGATED_COUNTS+x} ]; then echo "r'${VIASH_PAR_INPUT_SPATIAL_AGGREGATED_COUNTS//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'input_cell_volumes': $( if [ ! -z ${VIASH_PAR_INPUT_CELL_VOLUMES+x} ]; then echo "r'${VIASH_PAR_INPUT_CELL_VOLUMES//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'output': $( if [ ! -z ${VIASH_PAR_OUTPUT+x} ]; then echo "r'${VIASH_PAR_OUTPUT//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  'target_sum': $( if [ ! -z ${VIASH_PAR_TARGET_SUM+x} ]; then echo "float(r'${VIASH_PAR_TARGET_SUM//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/methods_normalization/normalize_by_counts",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
