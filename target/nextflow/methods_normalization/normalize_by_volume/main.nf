...
par = {
  ...
  'target_volume': $( if [ ! -z ${VIASH_PAR_TARGET_VOLUME+x} ]; then echo "float(r'${VIASH_PAR_TARGET_VOLUME//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/methods_normalization/normalize_by_volume",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
