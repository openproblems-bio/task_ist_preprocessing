...
meta = [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/methods_normalization/spanorm/config.vsh.yaml",
    "runner" : "nextflow",
...
par <- list(
  "input_spatial_aggregated_counts" = $( if [ ! -z ${VIASH_PAR_INPUT_SPATIAL_AGGREGATED_COUNTS+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_INPUT_SPATIAL_AGGREGATED_COUNTS" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
  "input_cell_volumes" = $( if [ ! -z ${VIASH_PAR_INPUT_CELL_VOLUMES+x} ]; then echo -n "'"; echo -n "$VIASH_PAR_INPUT_CELL_VOLUMES" | sed "s#['\\\\]#\\\\\\\\&#g"; echo "'"; else echo NULL; fi ),
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/methods_normalization/spanorm",
    "tag" : "build_main"
  },
  "label" : [
    "veryhightime",
