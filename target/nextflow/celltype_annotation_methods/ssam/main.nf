...
meta = [
      ...
      "arguments" : [
        {
          "type" : "file",
          "name" : "--input",
          "label" : "Spatial Normalised Counts",
          "summary" : "Normalised counts",
          "description" : "This file contains the normalised counts of the spatial transcriptomics data.\n",
          "info" : {
            "format" : {
              "type" : "h5ad",
              "layers" : [
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/celltype_annotation_methods/ssam/config.vsh.yaml",
    "runner" : "nextflow",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/celltype_annotation_methods/ssam",
    "tag" : "build_main"
  },
  "tag" : "$id"
}'''),
