...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "integer",
          "name" : "--bin_size",
          "description" : "Edge length of each square pseudo-cell bin, in PIXELS of the input `image`\nelement. On this benchmark's standardized raw_ist grid (images are rasterized\nat target_unit_to_pixels=1, i.e. ~1 um/pixel) 1 px is ~1 um, so 30 px is\n~30 um bins. Used only when --bin_size_um is not set.\n",
          "default" : [
            30
          ],
          "required" : false,
        ...
        },
        {
          "type" : "double",
          "name" : "--bin_size_um",
          "description" : "Edge length of each square bin in MICRONS. When set, it OVERRIDES --bin_size:\nthe script reads the input image's coordinate transform (um per pixel) and\nconverts to a pixel bin size, so the physical bin size is comparable across\ndatasets even if they are gridded at different pixel sizes. Leave unset to use\n--bin_size (raw pixels).\n",
          "required" : false,
          "direction" : "input",
          "multiple" : false,
          "multiple_sep" : ";"
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/methods_segmentation/binning/config.vsh.yaml",
    "runner" : "nextflow",
...
par = {
  ...
  'bin_size_um': $( if [ ! -z ${VIASH_PAR_BIN_SIZE_UM+x} ]; then echo "float(r'${VIASH_PAR_BIN_SIZE_UM//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/methods_segmentation/binning",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
