...
meta = [
      ...
      "setup" : [
        {
          ...
          "user" : false,
          "pypi" : [
            "spatialdata, txsim, alphashape, descartes"
          ],
          "upgrade" : true
        }
      ]
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/cell_volume_methods/alpha_shapes/config.vsh.yaml",
    "runner" : "nextflow",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/cell_volume_methods/alpha_shapes",
    "tag" : "build_main"
  },
  "tag" : "$id"
}'''),
