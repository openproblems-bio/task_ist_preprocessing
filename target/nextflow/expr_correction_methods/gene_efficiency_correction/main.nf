...
meta = [
      ...
      "arguments" : [
        {
          "type" : "file",
          "name" : "--input",
          "label" : "Spatial Normalised Counts with Cell Type Annotations",
          "summary" : "Normalised counts with cell type annotations",
          "description" : "This file contains the normalised counts of the spatial transcriptomics data and cell type annotations.\n",
          "info" : {
            "format" : {
              "type" : "h5ad",
              "layers" : [
        ...
        },
        {
          "type" : "file",
          "name" : "--output",
          "label" : "Spatial Corrected Counts with Cell Type Annotations",
          "summary" : "Corrected counts with cell type annotations",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/expr_correction_methods/gene_efficiency_correction/config.vsh.yaml",
    "runner" : "nextflow",
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/expr_correction_methods/gene_efficiency_correction",
    "tag" : "build_main"
  },
  "tag" : "$id"
}'''),
