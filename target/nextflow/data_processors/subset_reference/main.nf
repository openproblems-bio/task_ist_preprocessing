...
meta = [
  ...
  "build_info" : {
    ...
    "viash_version" : "0.9.0",
    "git_commit" : "e0a044509b971a4b34bc142724aafcae602be22e",
...
par = {
  ...
  'n_cells': $( if [ ! -z ${VIASH_PAR_N_CELLS+x} ]; then echo "int(r'${VIASH_PAR_N_CELLS//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'min_n_cells_per_cell_type': $( if [ ! -z ${VIASH_PAR_MIN_N_CELLS_PER_CELL_TYPE+x} ]; then echo "int(r'${VIASH_PAR_MIN_N_CELLS_PER_CELL_TYPE//\\'/\\'\\"\\'\\"r\\'}')"; else echo None; fi ),
  'cell_type_key': $( if [ ! -z ${VIASH_PAR_CELL_TYPE_KEY+x} ]; then echo "r'${VIASH_PAR_CELL_TYPE_KEY//\\'/\\'\\"\\'\\"r\\'}'"; else echo None; fi ),
  ...
  'keep_tissue_categories': $( if [ ! -z ${VIASH_PAR_KEEP_TISSUE_CATEGORIES+x} ]; then echo "r'${VIASH_PAR_KEEP_TISSUE_CATEGORIES//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
