...
meta = [
  ...
  "argument_groups" : [
    {
      ...
      "arguments" : [
        ...
        },
        {
          "type" : "string",
          "name" : "--replicate_id",
          "description" : "The replicate to crop.",
          "required" : false,
          "direction" : "input",
          "multiple" : true,
          "multiple_sep" : ";"
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_imagingbased_st_preprocessing/task_imagingbased_st_preprocessing/src/data_processors/crop_region/config.vsh.yaml",
    "runner" : "nextflow",
    "engine" : "docker",
...
par = {
  ...
  'replicate_id': $( if [ ! -z ${VIASH_PAR_REPLICATE_ID+x} ]; then echo "r'${VIASH_PAR_REPLICATE_ID//\\'/\\'\\"\\'\\"r\\'}'.split(';')"; else echo None; fi ),
  'min_x': $( if [ ! -z ${VIASH_PAR_MIN_X+x} ]; then echo "list(map(int, r'${VIASH_PAR_MIN_X//\\'/\\'\\"\\'\\"r\\'}'.split(';')))"; else echo None; fi ),
  'max_x': $( if [ ! -z ${VIASH_PAR_MAX_X+x} ]; then echo "list(map(int, r'${VIASH_PAR_MAX_X//\\'/\\'\\"\\'\\"r\\'}'.split(';')))"; else echo None; fi ),
  'min_y': $( if [ ! -z ${VIASH_PAR_MIN_Y+x} ]; then echo "list(map(int, r'${VIASH_PAR_MIN_Y//\\'/\\'\\"\\'\\"r\\'}'.split(';')))"; else echo None; fi ),
  'max_y': $( if [ ! -z ${VIASH_PAR_MAX_Y+x} ]; then echo "list(map(int, r'${VIASH_PAR_MAX_Y//\\'/\\'\\"\\'\\"r\\'}'.split(';')))"; else echo None; fi )
}
meta = {
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_imagingbased_st_preprocessing/data_processors/crop_region",
    "tag" : "build_main"
  },
  "tag" : "$id"
}'''),
