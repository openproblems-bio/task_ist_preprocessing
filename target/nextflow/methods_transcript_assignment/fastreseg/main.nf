...
meta = [
  ...
  "description" : "fastReseg is an R package designed to enhance the precision of cell segmentation in spatial transcriptomics by \nleveraging transcriptomic data to correct and refine initial image-based segmentation results.\n",
  "test_resources" : [
    {
      "type" : "file",
  ...
  "build_info" : {
    "config" : "/home/runner/work/task_ist_preprocessing/task_ist_preprocessing/src/methods_transcript_assignment/fastreseg/config.vsh.yaml",
    "runner" : "nextflow",
...
$( if [ ! -z ${VIASH_PAR_INPUT_IST+x} ]; then echo "${VIASH_PAR_INPUT_IST}" | sed "s#'#'\\"'\\"'#g;s#.*#par_input_ist='&'#" ; else echo "# par_input_ist="; fi )
$( if [ ! -z ${VIASH_PAR_INPUT_SEGMENTATION+x} ]; then echo "${VIASH_PAR_INPUT_SEGMENTATION}" | sed "s#'#'\\"'\\"'#g;s#.*#par_input_segmentation='&'#" ; else echo "# par_input_segmentation="; fi )
...
meta["defaults"] = [
  ...
  "container" : {
    "registry" : "ghcr.io",
    "image" : "openproblems-bio/task_ist_preprocessing/methods_transcript_assignment/fastreseg",
    "tag" : "build_main"
  },
  "label" : [
    "midtime",
